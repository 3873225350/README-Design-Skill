...
<div align="center">
  ...
  <p>
    <img src="https://img.shields.io/badge/platform-Chrome%20%7C%20Firefox-10A37F" alt="platform" />
    <img src="https://img.shields.io/badge/export-Markdown%20%7C%20PDF-2563EB" alt="export" />
...
```mermaid
flowchart LR
    A["Long conversation"] --> B["Mark key turns"]
    B --> C["Read in focus view"]
    C --> D["Export clean notes"]
```
